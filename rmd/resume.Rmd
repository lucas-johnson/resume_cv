...
OSU$Bullets <- c(
  "Developed an interactive web map to support the joint consideration of carbon benefits and albedo offsets in tree-planting projects across the conterminous United States",
  # "Decomposing Nepal-wide forest carbon trends with NASA GEDI data to distribute REDD+ payments",
  "Building tools for equitable distribution of REDD+ payments using NASA GEDI data and ML"
)

CAFRI <- vector("list")
CAFRI$Details <- c("Research Assistant", "August 2019 - August 2024", "Climate and Applied Forest Research Institute", "Syracuse, NY")
CAFRI$Bullets <- c(
  "Developed an ML-based forest carbon mapping framework for the NYS DEC",
