...
OSU$Bullets <- c(
  "Developed a web map application to support the joint consideration of carbon benefits and albedo offsets in tree-planting projects across the conterminous United States",
