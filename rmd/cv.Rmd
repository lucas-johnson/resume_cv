...
tribble(
  ~ When, ~ Group, ~ Details,
  "2024 - Present", "Oregon State University - USFS", "\\textbf{Postdoctoral Scholar}. Quantifying radiative feedbacks associated with the albedo change that results from forest growth, reforestation, and afforestation. Assisting the operationalization of carbon reporting tools based on data from NASA's GEDI mission",
