...
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where, ~ Details,
    "Doctor of Philosophy in Environmental Science", "Aug 2019 - May 2024 (exp)", "State University College of Environmental Science and Forestry", "Syracuse, New York", "Dissertation: \\textit{Mapping forest aboveground biomass stocks and changes to facilitate natural climate solutions in New York State}",
...
tribble(
  ~ When, ~ Group, ~ Details,
  "2019 - Present", "Climate and Applied Forest Research Institute (SUNY ESF)", "\\textbf{Research Assistant}. Developed cloud computing infrastructure, geospatial databases, and data sharing software. Contributed writing, code, and statistical/spatial analysis to technical reports",
