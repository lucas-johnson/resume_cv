...
tribble(
  ~ When, ~ Group, ~ Details,
  "2024 - Present", "Oregon State University", "\\textbf{Postdoctoral Scholar}. Quantifying radiative feedbacks associated with the albedo change that results from forest growth, reforestation, and afforestation. Assisting in operationalizing forest carbon reporting tools that leverage data from NASA’s GEDI mission",
