...
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where, ~ Details,
    "Doctor of Philosophy in Environmental Science", "Aug 2019 - May 2024", "SUNY College of Environmental Science and Forestry", "Syracuse, New York", "Dissertation: \\textit{Mapping forest aboveground biomass stocks and changes to facilitate natural climate solutions in New York State}",
...
tribble(
  ~ When, ~ Title, ~ Details,
  "2026", "Reviewer:", "Forest Ecology and Management, Scientific Data",
  "2025", "World Bank Workshop Leader:", "Enhancing Digital MRV Technologies and Capacities in Papua New Guinea",
  "2025", "ESIP Lab Reviewer:", "Democratizing Geospatial AI/ML RFP",
  "2025", "Reviewer:", "Environmental Monitoring and Assessment, Remote Sensing in Ecology and Conservation",
  "2024", "Reviewer:", "Carbon Balance and Management, International Journal of Applied Earth Observation and Geoinformation",
...
tribble(
  ...
  "January 2026 - Present", "Guadalupe Center, SLC",
  "Learning Coach (Volunteer)", 
  "Weekly English tutoring for small groups of adult immigrants and refugees"
) %>% 
